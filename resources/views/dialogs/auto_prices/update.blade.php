	...
	<!-- Modal -->
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <form id="activeForm" method="POST" action="{{url('prices')}}/updatePrice">
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="number" value="{{$auto_service->cost}}" min="0" step="0.01" data-number-to-fixed="2"
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="number" value="{{$auto_service->timing}}" min="0" step="1" data-number-to-fixed="0"
